...
class GridBehavior(view: View) {
    ...
    fun getColIndex(screenPosition: Int): Int {
        ...
        val floatColIndex: Float =
            ((screenPosition.toFloat() - view.marginLeft.toFloat()) / view.width.toFloat()).coerceAtMost(0.9f)
                .coerceAtLeast(0f)
    ...
    fun getRowIndex(screenPosition: Int): Int {
        ...
        val floatRowIndex: Float =
            ((screenPosition.toFloat() - view.marginTop.toFloat()) / view.height.toFloat()).coerceAtMost(0.9f)
                .coerceAtLeast(0f)
